export default function HamburgerSlider ({ setLive, live }) {
    ...
    return (
        <div className="mt-0 lg:mt-4 flex ml-[10vw] lg:ml-[20vw] transparent relative zSlider">
            <label
                className=" w-[15rem] lg:w-[30rem] h-[2.5rem] react-switch">
                <input
                ...
                />
                <div
                    className="react-switch-button w-[7.5rem] lg:w-[15rem] h-[3rem] " />
                <div
